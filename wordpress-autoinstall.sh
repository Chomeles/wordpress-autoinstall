...
# Install Let's Encrypt client if it is not already installed
...
sudo certbot --nginx --agree-tos --redirect --hsts --staple-ocsp --email your-email@example.com -d $domain
